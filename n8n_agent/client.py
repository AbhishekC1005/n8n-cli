"""
Async n8n API Client for the Workflow Agent
===========================================
Self-contained, lightweight async client that handles communication directly 
...
class N8nClient:
    ...
    async def get_execution_details(self, execution_id: str) -> dict:
        """Fetch detailed information for a specific execution, including node errors."""
        c = await self._get_client()
